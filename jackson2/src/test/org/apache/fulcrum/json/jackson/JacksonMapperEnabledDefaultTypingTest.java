...
public class JacksonMapperEnabledDefaultTypingTest extends BaseUnitTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        ((Jackson2MapperService)sc).getMapper().enableDefaultTypingAsProperty( DefaultTyping.NON_FINAL, "type" );
    }

    public void testSerialize() throws Exception
    {
        String serJson = sc.ser( new JacksonMapperEnabledDefaultTypingTest("mytest") );
        assertEquals("Set failed ", "{\"type\":\"org.apache.fulcrum.json.jackson.JacksonMapperEnabledDefaultTypingTest\",\"name\":\"mytest\"}", serJson);
    }
    ...
    public void testSerializeDateWithDefaultDateFormat() throws Exception
    {
        ...
        assertTrue("Serialize with Adapater failed ", serJson.matches( ".*\"java.util.Date\",\"\\d\\d/\\d\\d/\\d{4}\".*" ));
    ...
    public void testDeSerializeDate() throws Exception
    {
        ...
        Map<String,Date> serDate = (Map<String,Date>)sc.deSer( serJson, Map.class );
        assertEquals("Date DeSer failed ", Date.class, serDate.get( "date" ).getClass());
    }
    ...
    { 
        ...
        assertEquals("Ser filtered Bean failed ", "{\"type\":\"org.apache.fulcrum.json.jackson.JacksonMapperEnabledDefaultTypingTest$Bean\",\"name\":\"joe\"}", bean);
    ...
    { 
        ...
        String result = sc.serializeOnlyFilter( beanList, Bean.class, "name", "age" );        
        List<Bean> beanList2 = (List<Bean>) ((Jackson2MapperService)sc).deSerCollection( result, List.class, Bean.class );
    ...
    public void testDeserializationUnTypedCollectionWithFilter() throws Exception
    { 
        ...
        {
            assertTrue("DeSer failed ", ((List)beanList2).get( i ) instanceof Bean);
            assertTrue("DeSer failed ", ((Bean)((List)beanList2).get( i )).getName().equals( "joe"+i ));
    ...
    {     
        Rectangle filteredRectangle = new Rectangle(5, 10);
        filteredRectangle.setName( "jim" );        
        String serRect =  sc.addAdapter("M4RMixin", Rectangle.class, Mixin.class ).ser( filteredRectangle );
    ...
    {     
        ...
        String serRect =  sc.addAdapter("M4RMixin2", Rectangle.class, Mixin2.class ).ser( filteredRectangle );
    ...
    { 
        ...
        String result = sc.addAdapter("M4RMixin", Bean.class, BeanMixin.class ).ser( beanList );
        assertEquals("Serialization of beans failed ", 
