        ...
        static int N = 3;// number of concurrent test methods = methods
         ...
         public void one() throws InterruptedException {
          ...
          private String doJob(String... filtereIds)  {
              ...
              {
                    assertTrue("Result does not contain ("+ filtereIds[i] +")", result.contains( "\""+filtereIds[i]+"\"" )  );   
              }
              return result;
          }
          ...
          private String serFiltered(List<?> list, Class<?> filterClass,
              ...
              Collection<AnnotationIntrospector> ais = ((AnnotationIntrospectorPair)mapper.getSerializationConfig().getAnnotationIntrospector()).allIntrospectors();
