 ...
 * 
 * If you want to call these methods from an environment, where you could only provide
 * strings (e.g. velocity context), just wrap the method and call
...
public interface JsonService
{
    ...
    /**
     * @param src        the java object to be serialized, not null.
     * @param cleanCache a boolean value, not null. If <code>true</code>, try to refresh cache
     *                   after serialization
     ...
     * @param cleanCache If <code>true</code>, try to clean cache after serialization
     * 
    ...
    /**
     * This is to deserialize collections. Depending on the implementation either both
     * collectiontype and elementType is needed or the elementType will be derived from the
     * typed collectiontype.
     * 
     * @param json           The JSON string to be deserialized
     * @param collectionType It could be just the collection or the typed collection. It may
     *                       then be used to get the type for element type too. Cft.
     *                       implementation tests for more details (GSON).
     * @param elementType    The element type. This is need in any case to assure the generic
     *                       checking.
     * @param <T>            class type of the object
    ...
    /**
     * This does a filtered convert, that is a filtered serialization of the source object and a deserialization in one call.
     * 
    ...
    /**
     * Custom method without caching. Caching is set to <code>false</code> for this method
     * call.
     * 
     ...
     * @param cleanFilter The Boolean value, not null. If it is <code>true</code>, cleans
     *                    cache and the custom filter after serialization.
     * 
    ...
    /**
     * @see #serializeOnlyFilter(Object, Class, Boolean, String...) Caching is set to
     *      <code>false</code> for this method call.
     * 
     * @param src         The Java object to serialize
    ...
    /**
     * Serialize only object properties where filter attributes are provided. If no filter is
     * set, no attributes should be returned.
     * 
     * @param src         The Java object to serialize
     * @param filterClass By default filterClass is a) the class to be filtered (required for
     *                    filtering list elements) b) the key in the filter object cached.
     * @param <T>         class type of the object
     * @param cleanFilter The Boolean value, not null. If it is <code>true</code>, cleans
     *                    cache and the custom filter after serialization.
     * 
    ...
    /**
     * Serialize all object properties excluding provided filters attributes. If no filter is
     * set, all attributes should be returned.
     * 
     * @param src         The Java object to serialize. By default the filtering is applied
     *                    for this class. By default the class of the src object is the key
     *                    for the filter object cached.
     * @param filterClass The class, which should be filtered out, if found as a property
     *                    type.
     * @param <T>         class type of the object
     * @param cleanFilter If <code>true </code> cleans filter (clean cache and custom filter
     *                    for this filterClass) after serialization.
    ...
    /**
     * Class Filter is derived from param src object class. <code>refreshFilter</code> is set
     * to <code>false</code> for this method call.
     * 
    ...
    /**
     * @see #serializeAllExceptFilter(Object, Class, Boolean, String...)
     * @param src        The Java object to serialize. By default the filtering is applied for
     *                   this class. By default the class of the src object is the key for the
     ...
     * JsonService implementation. Cft. to {@link #addAdapter(String, Class, Object)}
     * 
    ...
    /**
     * Add an adapter (mixin, serializer,..) for the target class depending on the JsonService
     * implementation. Adapters could by default not deregistered. If you want to get rid of
     * them, you may try to reinit the service (or overwrite with the same target type,
     * depending on implementation)
     * 
     * @param name   The name of the adapter
     * @param target The target class for this adapter
     * @param mixin  The adapter/mixin for the target object (module/serializer/deserializer)
     * 
    ...
    /**
     * @param df The {@link DateFormat} to be used by the JsonService, not null. It could be
     *           provided by component configuration too.
     * 
     */
